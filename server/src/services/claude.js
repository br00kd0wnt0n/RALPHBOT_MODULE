...
`;
  ...
  detectMood(response) {
    ...
    if (lowerResponse.includes('excited') || lowerResponse.includes('amazing') || lowerResponse.includes('cool')) {
      return 'excited';
    }
    
    if (lowerResponse.includes('error') || lowerResponse.includes('glitch') || lowerResponse.includes('bzzt')) {
      return 'error';
    }
    
    if (lowerResponse.includes('bored') || lowerResponse.includes('fidget')) {
      return 'bored';
    }
